...
=====*/
	...
	dojo.style = function(	/*DomNode|String*/ node, 
		...
		return (args == 1) ? s : _toStyleValue(n, style, s[style]||n.style[style]); /* CSS2||String||Number */
	}
	...
	var _sumAncestor = function(node, prop){
	...
	dojo._abs = function(/*DomNode*/node, /*Boolean?*/includeScroll){
		...
		if(d.isIE || (d.isFF >= 3)){
			...
			if(node["offsetParent"]){
				...
				ret.x -= _sumAncestor(n, "scrollLeft");
				ret.y -= _sumAncestor(n, "scrollTop");
