...
if (Browser.Engine.webkit && Browser.Engine.version < 420) Element..text = {
	get: function(){
...
Element..events = {set: function(events){
...
Element..styles = {set: function(styles){
